...
disease_list = {15: 'Fungal infection', 4: 'Allergy', 16: 'GERD', 9: 'Chronic cholestasis', 14: 'Drug Reaction',
...
def predict():
    if request.method == "POST":
        ...
        # diet and medication have to print properly

        return render_template('index.html', predicted_disease=predicted_disease, description=desc, precausion=my_prec, medication=med, diets=die,workout=my_wo)
